<template>
    <el-dialog class="gc-modal" :width="modal?.config?.width || 1200" v-bind="modal.config" :modelValue="open"
        destroy-on-close>
        <GcForm v-model:formData="formData" :options="modal.form" ref="formRef" />
        <template #footer>
