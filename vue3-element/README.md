...
基于 Element Plus 的组件库，提供了一系列常用的业务组件，用于快速构建后台管理系统页面。

**npm地址：https://www.npmjs.com/package/@mengtr/vue3-element**
...
<script setup lang="ts">
import { BaseTable, useTable } from '@mengtr/vue3-element'
import axios from 'axios'
