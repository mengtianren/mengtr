# @mengtr/vue3-element 组件库

@mengtr/vue3-element 是一个基于 Vue 3 和 Element Plus 开发的组件库，提供了一系列常用的业务组件，用于快速构建后台管理系统页面。
...
```bash
npm install @mengtr/vue3-element
```
...
import GcPage, { setTablePageKey } from '@mengtr/vue3-element'
...
```javascript
import { GPage, GTablePage, GSearch, GTable, GModal, GEditor, GForm, BaseTable, useTable, setTablePageKey } from '@mengtr/vue3-element'
```
...
import { GPage } from '@mengtr/vue3-element'
...
<script setup lang="ts">
import { GSearch } from '@mengtr/vue3-element'
...
<script setup lang="ts">
import { GTable } from '@mengtr/vue3-element'
...
```typescript
import { useTable } from '@mengtr/vue3-element'
